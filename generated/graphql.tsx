...
export type ArchivesQuery = { __typename?: 'Query' } & {
    posts: Array<
        { __typename?: 'Post' } & Pick<
            Post,
            'id' | 'title' | 'slug' | 'draft' | 'createdAt' | 'updatedAt'
        > & {
                author?: Maybe<
                ...
                >
                tags: Array<
                    { __typename?: 'Tag' } & Pick<Tag, 'id' | 'slug' | 'name'>
                >
            }
    >
}
...
export type CategoryPostsQuery = { __typename?: 'Query' } & {
    category?: Maybe<
        { __typename?: 'Category' } & {
            posts: Array<
                { __typename?: 'Post' } & Pick<
...
export type RecentPostsQuery = { __typename?: 'Query' } & {
    posts: Array<{ __typename?: 'Post' } & Pick<Post, 'id' | 'title' | 'slug'>>
}
...
export type TagsQuery = { __typename?: 'Query' } & {
    tags: Array<{ __typename?: 'Tag' } & Pick<Tag, 'id' | 'slug' | 'name'>>
}
...
export function useCategoryPostsQuery(
    ...
    return ApolloReactHooks.useQuery<
        CategoryPostsQuery,
        CategoryPostsQueryVariables
    >(CategoryPostsDocument, baseOptions)
}
export function useCategoryPostsLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
        CategoryPostsQuery,
        CategoryPostsQueryVariables
    >
...
export type CategoryPostsQueryHookResult = ReturnType<
    typeof useCategoryPostsQuery
>
export type CategoryPostsLazyQueryHookResult = ReturnType<
    typeof useCategoryPostsLazyQuery
>
export type CategoryPostsQueryResult = ApolloReactCommon.QueryResult<
    CategoryPostsQuery,
    CategoryPostsQueryVariables
>
...
export function useRecentPostsQuery(
    ...
    return ApolloReactHooks.useQuery<
        RecentPostsQuery,
        RecentPostsQueryVariables
    >(RecentPostsDocument, baseOptions)
}
export function useRecentPostsLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
        RecentPostsQuery,
        RecentPostsQueryVariables
    >
...
export type RecentPostsLazyQueryHookResult = ReturnType<
    typeof useRecentPostsLazyQuery
>
export type RecentPostsQueryResult = ApolloReactCommon.QueryResult<
    RecentPostsQuery,
    RecentPostsQueryVariables
>
